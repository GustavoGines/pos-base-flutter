...
// in frontend_desktop/test/features/auth/providers/auth_provider_test.dart.
...
class MockAuthRepository extends _i1.Mock implements _i3.AuthRepository {
  ...
  @override
  _i4.Future<Map<String, dynamic>> verifyPin(String? pin) =>
      (super.noSuchMethod(
        Invocation.method(
          #verifyPin,
          [pin],
  ...
  @override
  _i4.Future<Map<String, dynamic>> authorizePin(String? pin) =>
      (super.noSuchMethod(
        Invocation.method(
          #authorizePin,
          [pin],
  ...
  @override
  _i4.Future<void> logout(String? sessionToken) => (super.noSuchMethod(
        Invocation.method(
          #logout,
          [sessionToken],
        ),
  ...
  @override
  _i4.Future<Map<String, dynamic>?> validateToken(String? sessionToken) =>
      (super.noSuchMethod(
        Invocation.method(
          #validateToken,
          [sessionToken],
