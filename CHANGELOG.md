## [1.6.0] - 2026-08-26
### Added
- ?? Nuevo Sistema de Canales de Actualizaci�n (Estable / Beta) integrado.
- ?? Soporte oficial para despliegues m�viles integrados con el servidor.

### Changed
- ?? Mejorada la experiencia de usuario: el sonido del esc�ner en auditor�as y control de stock ahora suena natural y reacciona sin latencia.
- ? Optimizaci�n de Rendimiento: Limitador de peticiones silenciosas que reduce dr�sticamente el consumo de red y CPU del servidor al navegar entre pantallas.

### Fixed
- ?? Seguridad Reforzada: Correcci�n en el Muro de Fuego que provocaba bloqueos err�neos de permisos de Acceso Remoto.
...
- **Acceso Inteligente a Reportes:** El reporte de Consumo Interno ahora requiere explícitamente que el módulo de **Cuentas Corrientes** esté habilitado, asegurando que la herramienta solo esté visible cuando existan cuentas internas para auditar.
