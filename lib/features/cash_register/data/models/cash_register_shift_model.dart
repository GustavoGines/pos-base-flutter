...
class CashRegisterShiftModel extends CashRegisterShift {
  ...
  factory CashRegisterShiftModel.fromJson(Map<String, dynamic> json) {
    return CashRegisterShiftModel(
      ...
      totalExpenses: json['total_expenses'] != null ? double.parse(json['total_expenses'].toString()) : null,
      totalWithdrawals: json['total_withdrawals'] != null ? double.parse(json['total_withdrawals'].toString()) : null,
      totalDeposits: json['total_deposits'] != null ? double.parse(json['total_deposits'].toString()) : null,
      status: json['status'],
